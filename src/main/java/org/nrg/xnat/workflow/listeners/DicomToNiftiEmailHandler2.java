 ...
 */
@Service
public class DicomToNiftiEmailHandler2 extends PipelineEmailHandlerAbst implements Consumer<Event<WorkflowStatusEvent>> {
    final static Logger logger = Logger.getLogger(DicomToNiftiEmailHandler2.class);

    private final String PIPELINE_NAME = "DicomToNifti/DicomToNifti.xml";
    private final String PIPELINE_NAME_PRETTY = "DicomToNifti";

    @Autowired
    public DicomToNiftiEmailHandler2(EventBus eventBus){
